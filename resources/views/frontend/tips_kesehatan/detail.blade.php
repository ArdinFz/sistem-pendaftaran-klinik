...
<body class="medical-pattern min-h-screen flex flex-col pb-6 select-none">
    ...
    <header class="bg-[#005b66] text-white py-4 px-6 flex items-center relative sticky top-0 z-40 shadow-md max-w-[480px] mx-auto w-full">
        <a href="{{ route('pasien.tips-kesehatan') }}" class="absolute left-6 hover:opacity-80 transition-opacity">
            <!-- Back Arrow SVG -->
    ...
    <main class="flex-1 max-w-[480px] w-full mx-auto px-5 py-6">
        ...
        <!-- Detail Card -->
        <div class="bg-white border border-[#005b66]/20 rounded-md p-5 shadow-sm space-y-5">
            
            <!-- Title -->
            <h2 class="text-center font-extrabold text-gray-950 text-base leading-snug">
            ...
            <!-- Content Body -->
            <div class="space-y-4 text-[11px] text-gray-700 font-bold leading-relaxed">
