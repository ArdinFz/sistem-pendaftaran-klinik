...
<head>
    ...
    <title>Lupa Password - Klinik Tadika Mesra</title>
...
<body class="medical-pattern min-h-screen flex flex-col">
    ...
    <header class="bg-[#005b66] text-white py-4 px-6 flex items-center shadow-md">
        <a href="{{ route('pasien.login') }}" class="hover:opacity-80 transition-opacity">
            <!-- Back Arrow SVG -->
    ...
    <main class="flex-1 flex flex-col items-center justify-center p-6">
        <div class="w-full max-w-md bg-white border border-teal-600 rounded-lg p-6 shadow-sm">
            ...
            <!-- Header Text -->
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-[#005b66] mb-1">Lupa Password?</h1>
                <p class="text-sm font-medium text-teal-800">AKsokwosaksk gabisa masuk akun luwh</p>
            </div>
            ...
            <!-- Form -->
            <form action="{{ route('pasien.password.forgot.send') }}" method="POST" class="space-y-4">
                @csrf
            ...
            <div class="mt-8 text-center text-xs text-gray-500">
                Ingat Password?<br>
                <a href="{{ route('pasien.login') }}" class="text-[#005b66] font-bold hover:underline">ya ngapain atuh pencet "Lupa Kata Sandi?"</a>
            </div>
