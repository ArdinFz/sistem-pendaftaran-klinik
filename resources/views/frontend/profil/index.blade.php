...
<div id="content-akun" class="tab-content space-y-6 hidden">
    ...
    <div class="bg-white border border-gray-400 rounded-lg p-5 shadow-sm">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
            ...
            <div class="flex items-center space-x-4 pb-5 border-b border-gray-100 md:border-b-0 md:border-r md:pb-0 md:pr-6 md:space-x-6">
                <!-- Avatar -->
            ...
            <div class="space-y-3">
                ...
                <!-- Data Pribadi -->
                <button class="w-full bg-white border border-gray-300 hover:bg-gray-50 transition-colors rounded-lg px-4 py-3 flex items-center justify-between shadow-sm focus:outline-none cursor-default">
